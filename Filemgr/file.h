...
// ----------------------------------------------------------------------- //
// Language:    Visual C++, Visual Studio 2018                             //
// Application: Summer Projects, 2012                                      //
// Author:      Tanming Cui, Syracuse University                           //
/////////////////////////////////////////////////////////////////////////////
/*
* Module Operations:
* ==================
* This module provides classes, File, Path, Directory, and
* FileSystemSearch.
*
...
* Build Command:
* ==============
* cl /EHa /TEST_FILEMGR filemgr.cpp
*
* Maintenance History:
* ====================
* ver  2.7 : 05 Mar 2018
* - Separate class and its member method, and add to the repository project
* ver 2.6 : 04 Apr 15
...
namespace Repository
{
	...
	{
	public:
		FileSystemSearch() : pFindFileData(&FindFileData) {};
		~FileSystemSearch() { ::FindClose(hFindFile); };
		...
		std::string nextDirectory() {
			while (::FindNextFileA(hFindFile, pFindFileData))if (pFindFileData->dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY)return pFindFileData->cFileName;
			return "";
		}
		void close() { ::FindClose(hFindFile); };
	private:
		HANDLE hFindFile;
